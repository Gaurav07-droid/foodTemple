    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            type === 'Restaurant' ? URL = "/api/v1/restaurants/".concat(Id) : URL = "/api/v1/users/".concat(Id);
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: URL
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/restaurants/distances/".concat([lat, lng], "/unit/km")
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/bookings/checkout-session/".concat(restoId)
            });
