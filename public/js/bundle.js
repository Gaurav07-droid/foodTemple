...
},{}],"update.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            // console.log(res);
            if (res.data.status === 'success') (0, _alert.showAlert)('success', 'Data updated succesfully!');
...
exports.deleting = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            type === 'Restaurant' ? URL = "http://127.0.0.1:8000/api/v1/restaurants/".concat(Id) : URL = "http://127.0.0.1:8000/api/v1/users/".concat(Id);
            _context3.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
              url: URL
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"location.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCordinates = void 0;
...
var textDistance = document.getElementById('distance-text');
var distanceBtn = document.querySelector('.btn--green');
var restoName;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/restaurants/distances/".concat([lat, lng], "/unit/km")
            });
...
var getCordinates = function getCordinates() {
  if (navigator.geolocation) navigator.geolocation.getCurrentPosition(function (position) {
    var _position$coords = position.coords,
        latitude = _position$coords.latitude,
        longitude = _position$coords.longitude; // console.log(latitude, longitude);
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"auth.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.signUp = exports.login = exports.logOut = void 0;
...
var stripe = Stripe('pk_test_51LCGjjSF6JVrdN2LvSo0TaBeH7kz169qe9YqXn8472ewNgyGXUPxWDlr23ZTpN7VoKKWRFgvcdrl01VDz7aHKlNI00HUJio4pt');

var bookResto = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(restoId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(restoId)
            });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWdhdXJhdiIsImEiOiJjbDRiM3hwY20wMWs4M2JwYndvNWVkaXVuIn0.6k4MyfDgF-qHTcjJ45TIog';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //extends map bounds to the marker

    bounds.extend(loc.coordinates);
    new mapboxgl.Popup({
      closeOnClick: false,
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.address, "</p>")).addTo(map);
  });
...
var btnBookResto = document.getElementById('book-resto');
var inputName = document.getElementById('name');
var inputUserName = document.getElementById('user-name');
var inputEmail = document.getElementById('email');
var userPhoto = document.getElementById('photo');
var inputPass = document.getElementById('password'); // const inputConfirPass = document.getElementById('password-con');

var distanceBtn = document.getElementById('distance');
var inputCurPass = document.getElementById('password-current');
var inputConfPass = document.getElementById('password-confirm');
var passBtn = document.getElementById('passSaveBtn');
var btnDeleteResto = document.querySelectorAll('#delete-resto');
var btnDeleteUser = document.querySelectorAll('#delete-user'); // const signUpBtn = document.getElementById('signup');

var saveDataBtn = document.getElementById('saveData');
var formLogin = document.querySelector('.form_login');
var formDataUpdate = document.querySelector('.form-user-data');
var formPassUpdate = document.querySelector('.form-user-settings');
var formSignup = document.querySelector('.form_signup');
var mapEl = document.getElementById('map');
var logOutBtn = document.querySelector('.nav__el--logout'); // if(mapEl)
...
if (logOutBtn) logOutBtn.addEventListener('click', _auth.logOut); //Displaying map
...
if (formDataUpdate) formDataUpdate.addEventListener('submit', function (e) {
  ...
  (0, _update.updateData)(form); // updateData(fv);
...
if (formPassUpdate) formPassUpdate.addEventListener('submit', function (e) {
  e.preventDefault(); // console.log(inputCurPass.value, inputPass.value, inputConfPass.value);

  (0, _update.updatePassword)(inputCurPass.value, inputPass.value, inputConfPass.value);
